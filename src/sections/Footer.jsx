...
<p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'>Get shoes ready for the new term from your nearest Nike store. Find your perfect size in store.</p>
  ...
  {socialMedia.map((icon, index)=>(
    <div key={index} className='flex justify-center items-center w-12 h-12 bg-white rounded-full'>
      ...
      height={24} />
        ...
        <div className=' flex flex-1 justify-between lg:gap-7 gap-10 flex-wrap'>
